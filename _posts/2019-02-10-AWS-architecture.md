...
[<img class="img-post" src="{{ "/assets/images/posts/AWS-architecture/AWSServices" | prepend: site.baseurl }}" title="AWS Services" alt="AWS Services" width="600">](https://aws.amazon.com/de/products/)
